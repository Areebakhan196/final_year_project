...
DEFAULT_FROM_EMAIL = env('DEFAULT_FROM_EMAIL', default='The Silent Reporter <noreply@silentreporter.com>')
...
LOGGING = {
    ...
    'handlers': {
        'file': {
            ...
            'filename': os.path.join(BASE_DIR, 'logs/silent_reporter.log'),
            'formatter': 'verbose',
        },
        'console': {
            'level': 'DEBUG',
...
ANONYMITY_STRICT = True # If True, ensure no IP or metadata is stored.
